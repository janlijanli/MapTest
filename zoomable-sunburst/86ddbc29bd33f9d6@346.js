...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["flare-2.json",new URL("./files/json_data_2015.json",import.meta.url)]]);
...
d3.scaleOrdinal(d3.quantize(d3.interpolateCool, data.children.length + 1)) //original funktionierend
//d3.scaleOrdinal(d3.quantize(d3.schemeCategory20))
